...
@available(iOS 13.0, *) struct colorSchemeStruct {
    var light:Color!
    var dark:Color!
...
@available(iOS 13.0, *) extension Color {
    ...
    @available(iOS 14.0, *) var toUIColor:UIColor {
        return UIColor(self)
    }
...
//    @available(iOS 14.0, *) var convertToData:Data {
...
extension Data {
    ...
    var cgFloat: CGFloat { object() }
    var rgba: (red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat) {
        let size = MemoryLayout<CGFloat>.size
        return (subdata(in: size*0..<size*1).cgFloat,
                subdata(in: size*1..<size*2).cgFloat,
                subdata(in: size*2..<size*3).cgFloat,
                subdata(in: size*3..<size*4).cgFloat)
    }

    var toUIColor:UIColor? {
        if let (r, g, b, a) = self.rgba as (CGFloat, CGFloat, CGFloat, CGFloat)? {
    ...
    @available(iOS 13.0, *) var convertToColor:Color? {
        if let (r, g, b, a) = self.rgba as (CGFloat, CGFloat, CGFloat, CGFloat)? {
...
//        
//        return (red.data + green.data + blue.data + alpha.data)
//    }
